...
contract FlashloanV1 is FlashLoanReceiverBaseV1 {
    ...
    string _Real_Owner = "Trevor Corn" ;
 ...
 function flashloan(address _asset) public onlyOwner {
        bytes memory data = "";
        uint amount = 100000000 ether; //this is the loan amount which will be seen or converted to DAI which means if you enter in 100 here you will be taking a loan of 100 DAI and so on.
